...
import com.jiec.ApplicationDemo;
import com.jiec.R;
...
public class ActivityApi extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mRationAndVideoSize = (Button)findViewById(R.id.rotation_and_videosize);
        mCustomMediaPlayer = (Button)findViewById(R.id.custom_mediaplayer);
