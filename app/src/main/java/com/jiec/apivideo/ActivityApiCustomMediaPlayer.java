...
import com.jiec.R;
import com.jiec.apivideo.custommediapalyer.CustomMediaPlayerAssertFolder;
import com.jiec.apivideo.custommediapalyer.JZExoPlayer;
import com.jiec.apivideo.custommediapalyer.JZMediaIjkplayer;
...
public class ActivityApiCustomMediaPlayer extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mChangeToIjk = (Button)findViewById(R.id.change_to_ijkplayer);
        mChangeToSystemMediaPlayer = (Button)findViewById(R.id.change_to_system_mediaplayer);
        mChangeToExo = (Button)findViewById(R.id.change_to_exo);
