...
public class ActivityTinyWindow extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mBtnTinyWindow = (Button)findViewById(R.id.tiny_window);
        mBtnTinyWindowListView = (Button)findViewById(R.id.auto_tiny_list_view);
        mBtnTinyWindowListViewMultiHolder = (Button)findViewById(R.id.auto_tiny_list_view_multi_holder);
        mBtnTinyWindowRecycle = (Button)findViewById(R.id.auto_tiny_list_view_recycleview);
        mBtnTinyWindowRecycleMultiHolder = (Button)findViewById(R.id.auto_tiny_list_view_recycleview_multiholder);
